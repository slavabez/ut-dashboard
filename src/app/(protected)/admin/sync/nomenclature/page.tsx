...
const SyncNomenclaturePage = async ({
  searchParams,
}: {
  ...
  const totalSyncs = await getTotalSyncLogsAction("nomenclature");
  ...
  return (
    <div className="max-w-full">
      ...
      <UniversalPagination
        ...
        totalPages={maxPage}
        baseRoute="/admin/sync/nomenclature"
      />
...
export default SyncNomenclaturePage;
